...
import searchReducer from '@/store/reducers/search/searchSlice'
...
const rootReducer = combineReducers({
    ...
    auth: authReducer,
    profileAdvertisements: profileAdvertisementsReducer,
    createAdvertisement: createAdvertisementReducer,
